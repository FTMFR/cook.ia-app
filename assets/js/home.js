...
const /**{NodeList} */ $tabPanel = document.querySelectorAll('[data-tab-panel]');

let /**{NodeElement} */[$lastActiveTabPanel] = $tabPanel;
let /**{NodeElement} */[$LastActiveTabBtn] = $tabBtn;

addEventOnElements($tabBtn, 'click', function () {
...
addEventOnElements($tabBtn, 'keydown', function (e) {
...
const addTabContent = ($currentTabBtn, $currentTabPanel) => {
  ...
  fetchData([['mealType', $currentTabBtn.textContent.trim().toLowerCase()], ...cardQueries], function (data) {
    ...
    $currentTabPanel.innerHTML += `
                <a
                href="./recipe.html?mealType=${$currentTabBtn.textContent.trim().toLowerCase()}"
...
for (const [index, $sliderSection] of $sliderSections.entries()) {
  ...
  fetchData([...cardQueries, ['cuisineType', cuisineType[index]]], function (data) {
    ...
    $sliderWrapper.innerHTML += `
        ...
        <a href="./recipe.html?cuisineType=${cuisineType[index].toLocaleLowerCase()}" class="load-more-card has-state">
